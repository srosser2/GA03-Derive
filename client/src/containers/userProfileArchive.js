...
const UserProfile = ({ match }) => {
  ...
  switch (modalContent){
    ...
    case 'bio':
      ...
      break
    case 'formGeneral':
      modalBody = <Form onSelectChange={(e) => handleSelectChange(e)} config={{ nationality: userForm.nationality, isTravelling: userForm.isTravelling, languages: userForm.languages }} onSubmit={handleSubmit} onChange={handleChange}/>
      break
  }
  ...
  return <>
    ...
    {user.isPublic && <>
      ...
      <div>
        ...
        <div>Currently Travelling: {userDisplay.isTravelling && userDisplay.isTravelling.value === true ? 'Yes' : 'No'}</div>
      ...
      <div>
        ...
        <Card style={{ width: '45%' }}>
          <Card.Body>
            <Carousel show={3}>
              {console.log(user.countriesWishList, "countries wishlist")}
